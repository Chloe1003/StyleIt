...
<div class="styling">
<div class="s-header">내가 좋아하는 스타일링 리스트  / <span style="position: relative; left: 7px; font-size: 15px; font-weight: bold;">
								${countStylingLike } 개</span></div>
	<div class="styling-area">
	
	<c:if test="${sKList.size()>0 }">
	<c:forEach items="${sKList }" var="p" begin="0" end="${sKList.size()-1 }">
