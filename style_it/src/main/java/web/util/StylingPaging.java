...
public class StylingPaging {
	...
	// 총 게시글 수만 입력하는 생성자
	public StylingPaging(int totalCount) {
	...
	public StylingPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public StylingPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public StylingPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0) setListCount(9); // 게시글 10개로 설정
		if(pageCount == 0) setPageCount(5); // 페이징 10개로 설정
